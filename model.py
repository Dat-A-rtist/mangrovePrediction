...
final_merge = merged_df[['Species','Growth','Altitude_x','Patch_type','Survival']]
...
X = final_merge[['Species', 'Altitude_x', 'Patch_type', 'Growth']]
...
#accuracry after altitude Accuracy: 0.6318853560232871
